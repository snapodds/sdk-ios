...
#ifndef SNAPSCREENFRAMEWORK_SWIFT_H
#define SNAPSCREENFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SnapscreenFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19SnapscreenFramework18SnapViewController")
...
@interface SnapViewController (SWIFT_EXTENSION(SnapscreenFramework)) <AVCaptureVideoDataOutputSampleBufferDelegate>
/// :nodoc:
...
SWIFT_CLASS("_TtC19SnapscreenFramework27SnapscreenFingerprintResult")
@interface SnapscreenFingerprintResult : NSObject
/// Constructor for a fingerprinting result - intented to be used only by Snapscreen internally
- (nonnull instancetype)initWithFingerprintData:(NSData * _Nullable)fingerprintData preprocessedImageData:(NSData * _Nullable)preprocessedImageData preprocessedImageWidth:(NSInteger)preprocessedImageWidth preprocessedImageHeight:(NSInteger)preprocessedImageHeight preprocessedImageChannels:(NSInteger)preprocessedImageChannels quadrangle:(SnapscreenQuadrangle * _Nullable)quadrangle timestamp:(int64_t)timestamp OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC19SnapscreenFramework20SnapscreenQuadrangle")
@interface SnapscreenQuadrangle : NSObject
...
/// Fourth point of the quadrangle
@property (nonatomic, readonly) CGPoint point4;
/// Constructor for a quadrangle - intented to be used only by Snapscreen internally
- (nonnull instancetype)initWithPoint1:(CGPoint)point1 point2:(CGPoint)point2 point3:(CGPoint)point3 point4:(CGPoint)point4 OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
